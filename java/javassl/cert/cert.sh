...
rm *.req *.key *.crt index.txt* serial* *.pem *.p12
...
openssl ca -gencrl -out my.crl -config openssl.cnf
...
keytool -import -alias Client -keystore trustStore.p12 -storepass Aa123456 -noprompt -file RootCA.pem
